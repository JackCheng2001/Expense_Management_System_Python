...
class Expenses_Test(unittest.TestCase):
    ...
    def test_get_expense(self):
        ...
        # Test another existing expense type
        self.assertAlmostEqual(825, expenses_manager.get_expense(self.expenses, "rent").amount)
        # Test getting an expense type with mixed casing
        self.assertEqual(None, expenses_manager.get_expense(self.expenses, "COFFEE"))
    ...
    def test_add_expense(self):
        ...
        expenses_manager.add_expense(self.expenses, "coffee", 10)
        self.assertAlmostEqual(22.40, self.expenses.get("coffee").amount)

        # Test adding zero to a new expense
        expenses_manager.add_expense(self.expenses, "internet", 0)
        self.assertAlmostEqual(0, self.expenses.get("internet").amount)
    ...
    def test_deduct_expense(self):
        ...
        with self.assertRaises(RuntimeError):
            expenses_manager.deduct_expense(self.expenses, "coffee", 1000)
        # Test deducting from non-existing expense
        expenses_manager.deduct_expense(self.expenses, "internet", 10)
        self.assertNotIn("internet", self.expenses)
    ...
    def test_update_expense(self):
        ...
        # Test updating an existing expense to zero
        expenses_manager.update_expense(self.expenses, "rent", 0)
        self.assertAlmostEqual(0, expenses_manager.get_expense(self.expenses, "rent").amount)

        # Test updating a non-existing expense
        expenses_manager.update_expense(self.expenses, "internet", 50)
        self.assertNotIn("internet", self.expenses)
    ...
    def test_sort_expenses(self):
        ...
        amount_sorted_expenses = [('rent', 825.0),
                                  ...
                                  ('coffee', 12.4),
                                  ('food', 5.0)]
        print(expenses_manager.sort_expenses(self.expenses, "amount"))
    ...
    def test_export_expenses(self):
        ...
        file = 'export2.txt'
        expense_types = ['coffee', 'sports', 'music']
        expenses_manager.export_expenses(self.expenses, expense_types, file)
        ...
        f.close()
        self.assertEqual('coffee: 12.40', lines[0].strip())
        self.assertEqual('music: 324.00', lines[1].strip())
